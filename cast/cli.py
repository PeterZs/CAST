...
Examples:
  ...
  python -m cast.cli --image scene.jpg --no-intermediates
    ...
    parser.add_argument(
        "--mesh-provider",
        type=str,
        choices=["tripo3d", "trellis", "hunyuan"],
        default="trellis",
        help="Mesh provider (default: trellis). hunyuan uses Hunyuan3D-Omni for geometry with point cloud conditioning and Hunyuan3D-2.1 for texture painting"
    )
